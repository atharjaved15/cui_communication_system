...
class _addFacultyState extends State<addFaculty> {
  ...
  var storage = FirebaseStorage.instance.ref('Faculty').child(faker.person.name().toString());
  ...
  String uImage,uid,uEmail,uName;
  ...
  saveData(){
    _firebaseFirestore.collection('users').doc('faculty').collection('user').doc('$uid').set(
        {
          'UserID' : uid,
          'UserEmail ' : uEmail,
          'UserImage' : DPpath,
                ...
                children: [
                  Column(
                    children: [
                      ...
                      Text('Add A Faculty Member' , style: TextStyle(color: Colors.purple, fontSize: 25, fontWeight: FontWeight.bold),),
                        ...
                        child: Stack(
                          children: [
                            ...
                            Positioned(
                              ...
                              child: image == null ? Icon(Icons.add_a_photo , size: 50,) : CircleAvatar(
                                  radius: 100,
                                  child: ClipOval(
                                      child: new SizedBox(
                                        width: 150.0,
                  ...
                  Column(
                    children: [
                      MaterialButton(
                        ...
                        child: Center(
                          child: Text('Add Faculty Member', style: TextStyle(color: Colors.white),),
                        ),
                      )
                    ],
                  ),
