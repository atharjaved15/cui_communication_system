...
class membersList extends StatefulWidget {
  ...
  @override
  createState() => _membersListState();
}

class _membersListState extends State<membersList> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    tabBarViews = [TestScreen1(senderId: widget.senderId,), TestScreen2(SenderId: widget.senderId,)];
                ...
                if(snapshot.hasData){
                  ...
                  return ListView(
                      children: documents
                          ...
                          InkWell(
                            onTap: (){
                              Navigator.push(context, MaterialPageRoute(builder: (context) => (ChatScreen(receiverId: doc['UserID'], senderId: widget.senderId, auth: FirebaseAuth.instance,))));
                            },
                            child: Padding(
