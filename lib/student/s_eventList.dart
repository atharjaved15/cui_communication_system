import 'package:cui_communication_system/student/s_eventDetails.dart';
...
class s_eventList extends StatefulWidget {
  @override
  _s_eventListState createState() => _s_eventListState();
}

class _s_eventListState extends State<s_eventList> {
              ...
              if(snapshot.hasData){
                ...
                return ListView(
                    children: documents
                        ...
                        InkWell(
                          onTap: (){
                            Navigator.push(context, MaterialPageRoute(builder: (context) => s_eventDetails(docId: doc.id.toString(),title: doc['title'],date: doc['date'],details: doc['details '],)));
                          },
                          child: Padding(
