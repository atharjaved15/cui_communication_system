...
class s_studentList extends StatefulWidget {
  @override
  _s_studentListState createState() => _s_studentListState();
}

class _s_studentListState extends State<s_studentList> {
  @override
              ...
              if(snapshot.hasData){
                ...
                return ListView(
                    children: documents
                        ...
                        InkWell(
                          onTap: (){
                            Navigator.push(context, MaterialPageRoute(builder: (context) => s_profileDetails(uid: doc['UserID'], name: doc['UserName'], image: doc['UserImage'],)));
                          },
                          child: Padding(
