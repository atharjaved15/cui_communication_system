...
class _uploadEventsState extends State<uploadEvents> {
  ...
  saveData(){
    _firebaseFirestore.collection('Events').doc('Uploaded').collection('Events').doc().set(
        {
          'title' : title,
          'details ' : details,
          'Details ' : details,
      ...
      Fluttertoast.showToast(msg: 'Event Uploaded Successfully!'),
              ...
              children: [
                Column(
                  children: [
                    ...
                    Text('Upload Event' , style:  TextStyle(fontSize: 25, color: Colors.red, fontWeight: FontWeight.bold ),),
                  ],
                ),
                Column(
                  children: [
                ...
                Column(
                  children: [
                    ...
                    color: Colors.purple,
                      ...
                      child: Center(child: Text('Post Event or News' , style: TextStyle(color: Colors.white),),),
                    ),
                  ],
                ),
              ],
