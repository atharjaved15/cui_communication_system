                            ...
                            children: [
                                ...
                                children: [
                                  Column(
                                    ...
                                    children: [
                                      Padding(
                                        padding: const EdgeInsets.only(left:20.0, top: 20, bottom: 5),
                                        child: Text('Want to Know' , style: TextStyle(color: Colors.white , fontSize: 16  , fontWeight: FontWeight.bold),),
                                      ),
                                      Padding(
                                        padding: const EdgeInsets.only(left: 20.0),
                                        child: Text('About US' , style: TextStyle(color: Colors.red , fontSize: 40  , fontWeight: FontWeight.bold),),
                                      ),
                                  ...
                                  Column(
                                    children: [
                                      Padding(
                                        padding: const EdgeInsets.all(8.0),
                                        child: Icon(Icons.sentiment_satisfied_alt_rounded , color: Colors.purple, size: 50,),
                                      ),
                                    ],
                                  ),
                                ],
                              ...
                              Row(
                                ...
                                children: [
                                  Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text('You can see some of the details about us' , style: TextStyle(color: Colors.white , fontSize: 10  ,fontStyle: FontStyle.italic, fontWeight: FontWeight.bold),),
                                  ),
                                ],
                              ),
                            ],
